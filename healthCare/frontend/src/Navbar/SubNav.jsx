    ...
    <Box  display={["none", "none", "block"]}>
      <Box>
        <Box w="80%" p="17px 0px" m="auto" mb="0px" display="flex" justifyContent="space-between" cursor={'pointer'} alignItems="center">
          <Box onClick={()=>handleHoverallcategory()} cursor='pointer' p="7px 17px" border="1px solid #a6a6a6" rounded="5px" display="flex" justifyContent="space-between" alignItems="center" >
            <Icon color="#2eb8b8" boxSize="22px" as={HiMenuAlt1} />
            <Text color="#949292" fontWeight={700} m="0">Shop By Category</Text>
          </Box>
          <Box w="80%" display="flex" gap="5px" justifyContent="space-between" alignItems="center">
          <Link onClick={()=>handleHoverbestSellers()} cursor='pointer' gap="5px" display="flex" justifyContent="space-between" alignItems="center">
            ...
            <Link display="flex" gap="5px" justifyContent="space-between" alignItems="center">
              ...
              <Text _hover={{ color:"#2eb8b8"}} fontSize="16px" color="#333333">Brands</Text>
            </Link>
