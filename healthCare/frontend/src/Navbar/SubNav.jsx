    ...
    <Box  display={["none", "none",'inline',"inline"]} responsive={responsive} position={'sticky'} zIndex={'9999'} top={'0'}>
      <Box bgColor={'#FFFFFF'} zIndex={'9999'}>
        <Box w={['0','0','100%',"80%"]} p="17px 0px" m="auto" mb="0px" display="flex" justifyContent="space-between" cursor={'pointer'} alignItems="center" bgColor={'#FFFFF'}>
          ...
          <Link onClick={()=>handleBestsellers()} cursor='pointer' gap="5px" display="flex" justifyContent="space-between" alignItems="center">
            ...
            <Box w="75%" fontSize="15px">
              <Box className='sportsnutritiondiv' display="flex" justifyContent="space-between">
                ...
                <Box w="20%">
                  ...
                  <Link href='' _hover={{color:"#b3ebeb"}}>L Carnitine</Link><br/>
                  <Link href='' _hover={{color:"#b3ebeb"}}>Multivitamins for Bodybuilding</Link><br/>
                  <Link href='' _hover={{color:"#b3ebeb"}}>Pre Hormone</Link><br/>
                  <Link href='' _hover={{color:"#b3ebeb"}}>ZMA</Link><br/>
                </Box>
              </Box>
            </Box>
          </Box>
