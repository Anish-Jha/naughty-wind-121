...
export default function Home() {
  ...
  return (
    <>
      ...
      <Flex width={['90%','85%','85%']} overflow={['scroll','scroll','hidden']} justifyContent={['left','left','center']} responsive={responsive} cursor='pointer' margin={'auto'} gap='10px'>
      ...
      <Flex width={['100%','100%%','100%']} overflow={['scroll','scroll','hidden']} justifyContent={['left','left','center']} responsive={responsive} cursor='pointer' margin={'auto'} gap='10px'>
      ...
      <Box width={'85%'} cursor='pointer' margin='auto' responsive={responsive}>
      <Heading fontSize={'26px'} textAlign={'left'} marginBottom='10px'>Pick Of The Day</Heading>
      <Box>
      <Slider4/>
      </Box>
      </Box>
      ...
      <Box width={'85%'} cursor='pointer' margin='auto' responsive={responsive}>
      <Heading fontSize={'26px'} textAlign={'left'} marginBottom='10px'>Workout Essentials</Heading>
      <Box>
      <Slider5/>
      </Box>
      </Box>
      ...
      <Box width={'85%'} cursor='pointer' margin={'auto'} responsive={responsive}>
      <Heading fontSize={'26px'} textAlign={'left'} marginBottom='20px'>Brand Range</Heading>
      <Flex width={['100%','100%%','100%']} overflow={['scroll','scroll','hidden']} justifyContent={['left','left','center']} responsive={responsive} cursor='pointer' margin={'auto'} gap='10px'>
        <Image className='posters' borderRadius={'10px'} width='280px' src={first}/>
        <Image className='posters' borderRadius={'10px'} width='280px' src={second}/>
        <Image className='posters' borderRadius={'10px'} width='280px' src={third}/>
        <Image className='posters' borderRadius={'10px'} width='280px' src={fourth}/>
        {/* <Image className='posters' borderRadius={'10px'} width='280px' src={fifth}/> */}
        <Image className='posters' borderRadius={'10px'} width='280px' src={sixth}/>
        <Image className='posters' borderRadius={'10px'} width='280px' src={seventh}/>
        <Image className='posters' borderRadius={'10px'} width='280px' src={eigth}/>
      </Flex>
      </Box>
      ...
      <Heading fontSize={'26px'} textAlign={'left'} marginBottom='20px' fontFamily={'montserrat,sans-serrif'}>Why HealthKart ?</Heading>
      <Box className="why_healthkart" width={'100%'} display={['block','flex','flex']} justifyContent={['space-between']}>
      <Box >
      ...
      <Box display={['none','none','block']} width='100%' h='10px' bgColor={'#e0dfdf'} marginTop='40px' marginBottom={'40px'}>
      </Box>
